...
import * as RootUI$HtmlToRescriptJsx from "./RootUI.bs.js";
import * as SampleTemplate$HtmlToRescriptJsx from "./sampleTemplate.bs.js";

import "./index.css"
;

function convertWithIntroOutro(prim) {
  return Converter.convertWithIntroOutro(prim);
}
...
function Index$App(Props) {
  ...
  return React.createElement(RootUI$HtmlToRescriptJsx.make, {
              children: React.createElement("div", undefined, React.createElement("div", {
                        className: "mt-4 md:grid grid-cols-2"
                            ...
                            className: "mr-4"
                                ...
                                defaultValue: SampleTemplate$HtmlToRescriptJsx.template,
